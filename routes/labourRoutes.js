...
// server.js or routes/documents.js




// Map document types to DB fields
const fieldMap = {
    ...
    try {
      ...
      if (cropData) {
        try {
          ...
          console.log("Invalid crop data, using original image");
        }
      }
      ...
      await sharpInstance.jpeg({ quality: 90 }).toFile(processedFilePath);
      ...
      // Remove old image from DB record
